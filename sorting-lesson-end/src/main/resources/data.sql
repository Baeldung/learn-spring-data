...
INSERT INTO Worker(id, email, first_name, last_name) VALUES(2, 'smith@test.com', 'John', 'Smith');
...
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status, assignee_id) VALUES (5, uuid(), 'Copying Task', '2025-03-17', 'Copying Task 2 Description', 1, 0, 2);
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status, assignee_id) VALUES (6, uuid(), 'Copying Task', '2025-03-17', 'Copying Task 2 Description', 1, 0, 1);
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status, assignee_id) VALUES (7, uuid(), 'Task 7', NULL, 'Task 7 Description', 1, 0, 1);