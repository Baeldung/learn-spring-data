...
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status, assignee_id) VALUES (default, uuid(), 'Copying Task', '2025-03-17', 'Copying Task 2 Description', 1, 0, 2);
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status, assignee_id) VALUES (default, uuid(), 'Copying Task', '2025-03-17', 'Copying Task 2 Description', 1, 0, 1);
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status, assignee_id) VALUES (default, uuid(), 'Task 7', NULL, 'Task 7 Description', 1, 0, 1);