...
INSERT INTO Project(id, code, name, description) VALUES (default, 'NEW1', 'new project', 'new project description');
INSERT INTO Project(id, code, name, description) VALUES (default, 'NEW2', 'another project', 'another project description');
...
INSERT INTO Task(id, uuid, name, due_date, description, project_id, status) VALUES (default, uuid(), 'Task 4', '2025-01-01', 'task name', 4, 0);