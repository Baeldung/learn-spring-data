...
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, status) VALUES (default, uuid(), 'Task 5', '2020-01-01', 'Task 5 Description', 1, 0);
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, status) VALUES (default, uuid(), 'Task 6', '2020-01-01', 'Task 6 Description', 1, 3);