...
class ApplicationLogsIntegrationTest {
    ...
    @Test
    void whenApplicationIsStarted_thenLogsContainExpectedText() throws InterruptedException {
        Thread.sleep(500);
        assertThat(LoggerListAppender.getEvents()).haveAtLeastOne(eventContains("Starting Spring Boot application..."));
    }
