...
INSERT INTO Task(id, name, due_date, description, project_id, status) VALUES (1, 'Task 1', '2025-01-12', 'Task 1 Description', 1, 0);
INSERT INTO Task(id, name, due_date, description, project_id, status) VALUES (2, 'Task 2', '2025-02-10', 'Task 2 Description', 1, 0);
INSERT INTO Task(id, name, due_date, description, project_id, status) VALUES (3, 'Task 3', '2025-03-16', 'Task 3 Description', 1, 0);
