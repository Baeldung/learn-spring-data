...
INSERT INTO Campaign(id, code, name, description) VALUES (default, 'NEW1', 'new campaign', 'new campaign description');
INSERT INTO Campaign(id, code, name, description) VALUES (default, 'NEW2', 'another campaign', 'another campaign description');
...
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, status) VALUES (default, uuid(), 'Task 4', '2025-01-01', 'task name', 4, 0);