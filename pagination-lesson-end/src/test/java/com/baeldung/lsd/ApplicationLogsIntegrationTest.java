...
class ApplicationLogsIntegrationTest {
    ...
    void whenApplicationIsStarted_thenExpectedFindByStatusLogs() throws InterruptedException {
        ...
        assertThat(LoggerListAppender.getEvents()).haveAtLeastOne(eventContains("All Tasks by status Paginated:\n "
                + "[Task [id=1, name=Task 1, description=Task 1 Description, dueDate=2025-01-12, status=TO_DO, project=Project [id=1, code=P1, name=Project 1, description=Description of Project 1], assignee=null], "
                + "Task [id=2, name=Task 2, description=Task 2 Description, dueDate=2025-02-10, status=TO_DO, project=Project [id=1, code=P1, name=Project 1, description=Description of Project 1], assignee=null]]"));
    ...
    void whenApplicationIsStarted_thenExpectedAllTasksByNameLogs() throws InterruptedException {
        ...
        assertThat(LoggerListAppender.getEvents()).haveAtLeastOne(eventContains("Page Two of All Tasks By Name:\n "
                + "[Task [id=3, name=Task 3, description=Task 3 Description, dueDate=2025-03-16, status=TO_DO, project=Project [id=1, code=P1, name=Project 1, description=Description of Project 1], assignee=null], "
                + "Task [id=4, name=Task 4, description=Task 4 Description, dueDate=2025-06-25, status=TO_DO, project=Project [id=2, code=P2, name=Project 2, description=About Project 2], assignee=Worker [id=1, email=john@test.com, firstName=John, lastName=Doe]]]"));
